...
ALLOWED_HOSTS = ['oz-km-crm.vercel.app', 'av22.pythonanywhere.com','192.168.5.213', 'localhost', '127.0.0.1']
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:8080',
    'http://192.168.5.213:8080',
    "http://av22.pythonanywhere.com"# Замените на адрес вашего фронтенда
    'https://oz-km-crm.vercel.app',  # Если вы хотите разрешить запросы с этого домена
    # Добавьте другие домены, если необходимо
]
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:8080',
    'http://av22.pythonanywhere.com/'
    'http://192.168.5.213:8080',  # Замените на адрес вашего фронтенда
    'https://oz-km-crm.vercel.app',  # Если вы хотите разрешить запросы с этого домена
